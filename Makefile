...
crack_captcha: captcha.h read_pbm.o copy_pixels.o get_properties.o crack.o get_bounding_boxs.o crack_captcha.o 
crack_digit: captcha.h read_pbm.o copy_pixels.o get_properties.o crack.o bounding_box.o crack_digit.o
